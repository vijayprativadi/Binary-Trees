...
namespace BinaryTrees
{
    ...
    public class BinaryTree
    {
        ...
        public bool CheckIfBinaryTreesAreIsomorphic(Node t1, Node t2)
        {
            if (t1 == null && t2 == null)
            {
                return true;
            ...
            return (CheckIfBinaryTreesAreIsomorphic(t1.left, t2.left) && checkIfBinaryTreesAreIdentical(t1.right, t2.right)) || (CheckIfBinaryTreesAreIsomorphic(t1.left, t2.right) && checkIfBinaryTreesAreIdentical(t1.right, t2.left));
        }
    }
}
